...
void GlauberModelPbPb502TeV(){
  ...
  //set constant parameters (see https://arxiv.org/pdf/1710.07098.pdf)
  const double pi = TMath::Pi();
  const double R = 6.624;
  const double a = 0.549;
  //const double a = 0.515;//weighted average of 0.447(p) and 0.560(n)
  const double max = 2*R;
  const double sigma = 6.76; //67.6 mb (1 b = 10^-28 m^2 = 100 fm^2)
  ...
  //Save data
  TFile outfile (Form("GlauberModelDataPbPb502TeV%i.root",NEvents), "RECREATE");
  ntuple->Write();
  outfile.Close();
